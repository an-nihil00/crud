defmodule Chan.BoardsTest do
  ...
  describe "boards" do
    ...
    @valid_attrs %{abb: "some abb", name: "some name", total_posts: "some total_posts"}
    @update_attrs %{abb: "some updated abb", name: "some updated name", total_posts: "some updated total_posts"}
    ...
    test "create_board/1 with valid data creates a board" do
      ...
      assert board.abb == "some abb"
      assert board.name == "some name"
      assert board.total_posts == "some total_posts"
    end
    ...
    test "update_board/2 with valid data updates the board" do
      ...
      assert board.abb == "some updated abb"
      assert board.name == "some updated name"
      assert board.total_posts == "some updated total_posts"
    end
  ...
  describe "boards" do
    ...
    @valid_attrs %{abb: "some abb", name: "some name", total_posts: 42}
    @update_attrs %{abb: "some updated abb", name: "some updated name", total_posts: 43}
    @invalid_attrs %{abb: nil, name: nil, total_posts: nil}
